...
for x in range(5):
    ...
    if 'nota_1' != nome_menor_nota and 'nota_1' != nome_maior_nota and 'nota_1' != nota_adicionada_1 and 'nota_1' != nota_adicionada_2 and 'nota_1' != nota_adicionada_3:
        soma += nota_1
    ...
    elif 'nota_2' != nome_menor_nota and 'nota_2' != nome_maior_nota and 'nota_2' != nota_adicionada_1 and 'nota_2' != nota_adicionada_2 and 'nota_2' != nota_adicionada_3:
        soma += nota_2
        if nota_adicionada_1 == '':
    ...
    elif 'nota_3' != nome_menor_nota and 'nota_3' != nome_maior_nota and 'nota_3' != nota_adicionada_1 and 'nota_3' != nota_adicionada_2 and 'nota_3' != nota_adicionada_3:
        soma += nota_3
        if nota_adicionada_1 == '':
    ...
    elif 'nota_4' != nome_menor_nota and 'nota_4' != nome_maior_nota and 'nota_4' != nota_adicionada_1 and 'nota_4' != nota_adicionada_2 and 'nota_4' != nota_adicionada_3:
        soma += nota_4
        if nota_adicionada_1 == '':
    ...
    elif 'nota_5' != nome_menor_nota and 'nota_5' != nome_maior_nota and 'nota_5' != nota_adicionada_1 and 'nota_5' != nota_adicionada_2 and 'nota_5' != nota_adicionada_3:
        soma += nota_5
        if nota_adicionada_1 == '':
